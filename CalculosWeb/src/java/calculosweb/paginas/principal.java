...
public class principal extends AbstractPageBean {
    ...
    private HtmlCommandButton botaoJurosCDC = new HtmlCommandButton();

    public HtmlCommandButton getBotaoJurosCDC() {
        return botaoJurosCDC;
    }

    public void setBotaoJurosCDC(HtmlCommandButton hcb) {
        this.botaoJurosCDC = hcb;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("principal Initialization Failure", e);
    ...
    public String botaoJurosCDC_action() {
